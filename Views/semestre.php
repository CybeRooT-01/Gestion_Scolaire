<div class="container py-4">
  <h1 class="text-center mb-4">Gestion des Semestres</h1>
  <!-- ajout -->
  <form action="/semestre/create" method="POST">
    <div class="form-group">
      <label for="annee">Semestre</label>
      <input type="text" class="form-control" id="semestre" name="semestre" autocomplete="off">
    </div>
  ...
  <div class="card">
    <div class="card-header">
      <h2 class="card-title">Liste des semestres</h2>
    </div>
    <div class="card-body">
